...
### ขั้นตอนที่ 1 — วงจรการเข้าสู่ระบบ (Auth Flow ทั้งหมด)

ในแล็บประจำสัปดาห์นี้ เราจะลงมือสร้างหน้าต่างเข้าสู่ระบบของจริงที่รวบรวมองค์ประกอบทุกส่วนตั้งแต่ wk3 ไปจนถึง wk6 โดยเชื่อมโยงหน้าตา UI เข้ากับฟังก์ชันการจัดการของสถานะ (State) ควบคู่กับการสื่อสารกับ API

เส้นทางการไหลของข้อมูล (Flow) นับตั้งแต่ผู้ใช้กรอกอีเมลและรหัสผ่าน ไปจนถึงวินาทีที่ระบบตรวจสอบจนได้รับโทเค็น (Token) และพาเข้าสู่หน้าหลักของระบบ มีลำดับขั้นตอนและกลไกตัดสินใจดังแผนภาพต่อไปนี้:
